...
|---|---|---|
| Multi-controller: refuse, or a lock protocol over a shared fact? | 5 | v0 is single-controller per host; document the refusal. Filed as `docs/issues/0009` |
